...
│   ├── .zsh_linux_welcome             # Linux welcome → ~/.zsh_linux_welcome
│   ├── .zsh_mac_welcome               # macOS welcome → ~/.zsh_mac_welcome
│   ├── .zsh_wsl_welcome               # WSL welcome → ~/.zsh_wsl_welcome
│   ├── .zsh_wsl_comfyui_functions      # WSL ComfyUI helpers → ~/.zsh_wsl_comfyui_functions
...
*   **`home/.zsh_mac_welcome`, `home/.zsh_linux_welcome`, `home/.zsh_wsl_welcome`**: Small scripts that show a status overview when a new shell starts on each respective OS.
*   **`home/.zsh_wsl_comfyui_functions`**: WSL-specific ComfyUI helper functions (optional, WSL only).

...
`rm` is a shell function wrapper that routes deletions to trash — never delete files in Bash tool calls without explicit user confirmation; the wrapper may not be fully initialized in non-interactive shells.
